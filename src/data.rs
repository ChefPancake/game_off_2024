...
pub const WINDOW_RESOLUTION: Vec2 = Vec2::new(859.0, 483.0);

pub const FOREGROUND_TITLE_SCREEN: &str = "TitleScreen.png";
pub const FOREGROUND_IMAGE_PATH: &str = "FrontPanel_noarrows.png";
pub const FOREGROUND_NO_BUTTONS_IMAGE_PATH: &str = "FrontPanel_nobuttons.png";
...
pub const PROGRESS_BAR_TOTAL_UNITS: usize = LILGUYS_COUNT * 4 + 8 + 2;
